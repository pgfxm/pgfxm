var pageObj = {
    bindEvent:function(){
        ...
        $('.user-hfnr a,.user-hfnr2 a').on('click', function(e){//评论回复
            if($(this).parent().parent().find('.hfh-text').length){
                ...
                if($('.hfh-text').length){
                    ...
                    $(this).parent().parent().append($('<div class="hfh-text" style="display: block;"> <textarea name="hfnr" class=" font-Light"></textarea> <a href="javascript:void(0)">回复</a> </div>'));
                }
            }
        ...
        $('.user-pl').on('click', '.hfh-text a', function(e){
